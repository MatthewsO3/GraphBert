#python javascript_eval.py --data_file /home/mczap/GraphBert/GraphBERT/data/javascript/test.jsonl --model_checkpoint microsoft/graphcodebert-base --mask_ratio 0.15 --top_k 10 --max_examples 2500  --max_seq_length 512 --output_file results/testing_new_perplexity/base/evaluation_results_javascript.json
